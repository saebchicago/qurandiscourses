...
// (by necessity, no modules) in the inline JS of roots.html and
// themes.html — if this ever changes, change those too, and re-run
// build-root-analytics.mjs, build-cooccurrence.mjs, and
