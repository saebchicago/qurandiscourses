...
- It is **not** AI-generated commentary. An AI tool may help locate a candidate
  source, check code, or flag unclear prose, and that use must be disclosed in
  the PR. It may not originate the proposed theme, sectional divisions,
  interpretation, translation, root meaning, citation, or scholarly
...
2. **No AI-originated conclusions.** Candidate boundaries, themes,
   translations, glosses, citations, and interpretations generated by an AI
   tool are not publishable. Deterministic outputs from repository scripts may
   be published only with their named inputs, method, and limitations.
